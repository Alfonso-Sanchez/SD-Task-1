...
def enviar_y_recibir():
    ...
    channel3.queue_declare(queue='filtrar3')
    channel3.queue_declare(queue='filtradas3')
    channel3.basic_consume(queue='filtradas3', on_message_callback=callback, auto_ack=True)
