...
def filtrar_frase(frase):
    insultos = [i.decode() for i in r.smembers("server_insults_node2")]
...
def actualizar_estadisticas():
    ...
    while True:
        ...
        with lock:
            ...
            r.hset("stats_node2", mapping=stats)
            requests_last_second = 0
...
print("🟢 Nodo 2 arrancado. Esperando solicitudes (cola requests_node2)...")

while True:
    data = r.blpop("requests_node2", timeout=0)
    if not data:
        continue
